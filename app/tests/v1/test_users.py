...
class UserTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data = {
            ...
            'lastname': "Mwangi",
            'othernames': "antoo",
            'email': "antooMwangi@gmail.com",
            'phoneNumber': "+254762672352",
            'username': "antoMwangi",
    ...
    def test_post_user(self):
        ...
        response = self.app.post(
            "/api/v1/users", headers={'Content-Type': 'application/json'}, data=json.dumps(self.data3))
    ...
    def test_duplicate_username(self):
        ...
        self.app.post(
            "/api/v1/users", headers={'Content-Type': 'application/json'}, data=json.dumps(self.data3))
        response = self.app.post(
            "/api/v1/users", headers={'Content-Type': 'application/json'}, data=json.dumps(self.data4))
        result = json.loads(response.data)
        self.assertEqual(response.status_code, 400)
    ...
    def test_wrong_key_in_post(self):
        ...
        response = self.app.post(
            "/api/v1/users", headers={'Content-Type': 'application/json'}, data=json.dumps(self.data2))
        result = json.loads(response.data)
        self.assertEqual(response.status_code, 500)
        self.assertEqual(
            result['error'], 'KeyError for email/password not posted')

    def test_get_specific_user(self):
        """Test get a specific user"""
        self.app.post(
            "/api/v1/users", headers={'Content-Type': 'application/json'}, data=json.dumps(self.data))
    ...
    def test_edit_specific_user(self):
        ...
        response = self.app.put(
            "/api/v1/users/1", headers={'Content-Type': 'application/json'}, data=json.dumps(self.data))
        result = json.loads(response.data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_update_status_of_user(self):
        ...
        response = self.app.patch("/api/v1/users/1/status", headers={
                                  'Content-Type': 'application/json'}, data=json.dumps({"isAdmin": False}))
        result = json.loads(response.data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_update_password_of_user(self):
        ...
        response = self.app.patch("/api/v1/users/1/password", headers={
                                  'Content-Type': 'application/json'}, data=json.dumps({"password": "roor212"}))
        result = json.loads(response.data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_wrong_status_key(self):
        ...
        response = self.app.patch("/api/v1/users/1/status", headers={
                                  'Content-Type': 'application/json'}, data=json.dumps({"isAdmins": True}))
        result = json.loads(response.data)
        self.assertEqual(response.status_code, 500)
    ...
    def test_wrong_password_key(self):
        ...
        response = self.app.patch("/api/v1/users/1/password", headers={
                                  'Content-Type': 'application/json'}, data=json.dumps({"pword": "jamd123"}))
        result = json.loads(response.data)
        self.assertEqual(response.status_code, 500)
        self.assertEqual(
            result['error'], "KeyError user's password not updated")
